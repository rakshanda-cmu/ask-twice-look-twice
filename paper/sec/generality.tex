...
\begin{table}[t]
\caption{RF20-VL detection, mean over 20 datasets and $3{,}970$ images,
multi-class prompting. Unlike every yes/no benchmark in this paper,
question-first \emph{beats} question-last here. Question echoing is still the
best ordering; the reversed echo, which is free on yes/no tasks, is the worst.}
\label{tab:rf20map}
\begin{center}
\small
