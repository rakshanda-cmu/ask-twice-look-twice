...
small, degrades monotonically. Metrics are F1 for POPE and RF20, group accuracy for Winoground, pair accuracy for NaturalBench. Blank cells were not run.}
