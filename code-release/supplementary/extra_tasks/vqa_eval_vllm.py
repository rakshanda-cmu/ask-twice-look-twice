...
Run:
  HF_HOME=hf_cache CUDA_VISIBLE_DEVICES=0,1 \
    python extra_tasks/vqa_eval_vllm.py \
...
def main():
    ...
    ap.add_argument("--data-dir", default="hf_cache/newtasks/vqa/val2014",
                    dest="data_dir")
    ap.add_argument("--vqa-dir", default="hf_cache/newtasks/vqa",
                    dest="vqa_dir")
