...
hf_cache/newtasks/{msvd_qa,tgif_qa}/).
...
Run:
  HF_HOME=hf_cache CUDA_VISIBLE_DEVICES=0,1 \
    python extra_tasks/video_qa_eval_vllm.py \
...
DATASET_CFG = {
    "msvd": {
        "root": "hf_cache/newtasks/msvd_qa/MSVD_Zero_Shot_QA",
        "q_file": "test_q.json", "a_file": "test_a.json",
        "video_dir": "videos", "video_ext": ".avi",
    },
    "tgif": {
        "root": "hf_cache/newtasks/tgif_qa/TGIF_Zero_Shot_QA",
        "q_file": "test_q.json", "a_file": "test_a.json",
